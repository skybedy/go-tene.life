...
var dictionary = map[string]map[string]string{
	"cs": {
		...
		"sounds_choose_lesson_below":   "Vyberte z lekcí níže",
		"sounds_select_lesson_first":   "Nejprve si níže vyberte nějakou lekci.",
		"sounds_playlist_label":        "Jednotlivé lekce",
		"sounds_main_choices_label":    "Základní volby",
		"sounds_no_tracks":             "Zatím nejsou k dispozici žádné zvukové soubory.",
		"sounds_play":                  "Přehrát",
		"sounds_play_once":             "Přehrát",
		"sounds_play_loop":             "Přehrát ve smyčce",
		"sounds_download":              "Stáhnout",
		"sounds_play_all":              "Přehrát 1-500",
		"sounds_play_random":           "Přehrát náhodně",
		"sounds_play_1_250":            "Přehrát 1-250",
		"sounds_play_251_500":          "Přehrát 251-500",
		"sounds_speed_label":           "Rychlost přehrávání",
		"sounds_selected":              "Vyberte způsob přehrávání nebo jednotlivou lekci",
		"sounds_now_playing":           "Aktuálně přehrávám",
		"sounds_hide_czech":            "Skrýt český překlad",
		"sounds_show_czech":            "Zobrazit český překlad",
		"daily_statistics":             "Denní statistiky",
		"recent_statistics":            "Posledních 10 dní",
		"tenerife_temperatures":        "Teplotní mapa Tenerife",
		...
		"monthly_daily_statistics":     "Dny v měsíci",
		"monthly_daily_short":          "Dny v měsíci",
		"monthly_daily_stats_subtitle": "Denní rozpis konkrétního měsíce, vyberte měsíc níže.",
		"select_month":                 "Měsíc",
		"annual_short":                 "Roční",
		...
		"no_data_for_today":            "Pro dnešní den ještě nemáme k dispozici data",
		"today_short":                  "Dnes",
		"show":                         "Zobrazit",
		...
		"enlarge_image":                "Zvětšit fotku",
		"site_title_suffix":            "Tenerife | Los Cristianos | Webcam",
		"pws_map_subtitle":             "Aktuální teploty z vybraných meteostanic na Tenerife.",
	...
	"en": {
		...
		"sounds_choose_lesson_below":   "Choose from lessons below",
		"sounds_select_lesson_first":   "Please select a lesson below first.",
		"sounds_playlist_label":        "Individual lessons",
		"sounds_main_choices_label":    "Main options",
		"sounds_no_tracks":             "No audio files are available yet.",
		"sounds_play":                  "Play",
		"sounds_play_once":             "Play",
		"sounds_play_loop":             "Play on loop",
		"sounds_download":              "Download",
		"sounds_play_all":              "Play 1-500",
		"sounds_play_random":           "Play randomly",
		"sounds_play_1_250":            "Play 1-250",
		"sounds_play_251_500":          "Play 251-500",
		"sounds_speed_label":           "Playback speed",
		"sounds_selected":              "Choose a playback mode or an individual lesson",
		"sounds_now_playing":           "Now playing",
		"sounds_hide_czech":            "Hide Czech translation",
		"sounds_show_czech":            "Show Czech translation",
		"daily_statistics":             "Daily Statistics",
		"recent_statistics":            "Last 10 Days",
		"tenerife_temperatures":        "Tenerife Temperature Map",
		...
		"monthly_daily_statistics":     "Days in a Month",
		"monthly_daily_short":          "Days in a Month",
		"monthly_daily_stats_subtitle": "Daily breakdown for a selected month, choose the month below.",
		"select_month":                 "Month",
		"annual_short":                 "Annual",
		...
		"no_data_for_today":            "No data is available for today yet.",
		"today_short":                  "Today",
		"show":                         "Show",
		...
		"enlarge_image":                "Enlarge photo",
		"site_title_suffix":            "Tenerife | Los Cristianos | Webcam",
		"pws_map_subtitle":             "Current temperatures from selected weather stations across Tenerife.",
...
func Messages(locale string) map[string]string {
	...
	for k, v := range monthlyDailyLocaleMessages[loc] {
		merged[k] = v
	}
	...
	for k, v := range seaTemperatureLocaleMessages[loc] {
		merged[k] = v
	}
...
var monthlyDailyLocaleMessages = map[string]map[string]string{
	"es": {
		"monthly_daily_statistics":     "Días del mes",
		"monthly_daily_short":          "Días del mes",
		"monthly_daily_stats_subtitle": "Desglose diario de un mes seleccionado, elija el mes abajo.",
		"select_month":                 "Mes",
	},
	"pl": {
		"monthly_daily_statistics":     "Dni w miesiącu",
		"monthly_daily_short":          "Dni w miesiącu",
		"monthly_daily_stats_subtitle": "Dzienny rozkład dla wybranego miesiąca, wybierz miesiąc poniżej.",
		"select_month":                 "Miesiąc",
	},
	"de": {
		"monthly_daily_statistics":     "Tage im Monat",
		"monthly_daily_short":          "Tage im Monat",
		"monthly_daily_stats_subtitle": "Tägliche Aufschlüsselung für einen ausgewählten Monat, wählen Sie den Monat unten.",
		"select_month":                 "Monat",
	},
	"fr": {
		"monthly_daily_statistics":     "Jours du mois",
		"monthly_daily_short":          "Jours du mois",
		"monthly_daily_stats_subtitle": "Détail quotidien d'un mois sélectionné, choisissez le mois ci-dessous.",
		"select_month":                 "Mois",
	},
	"it": {
		"monthly_daily_statistics":     "Giorni del mese",
		"monthly_daily_short":          "Giorni del mese",
		"monthly_daily_stats_subtitle": "Dettaglio giornaliero per un mese selezionato, scegliere il mese qui sotto.",
		"select_month":                 "Mese",
	},
	"hu": {
		"monthly_daily_statistics":     "Napok a hónapban",
		"monthly_daily_short":          "Napok a hónapban",
		"monthly_daily_stats_subtitle": "Napi bontás egy kiválasztott hónapra, válassza ki a hónapot alább.",
		"select_month":                 "Hónap",
	},
}
...
var seaTemperatureLocaleMessages = map[string]map[string]string{
	"cs": {
		"sea_temp_page_title_tenerife": "Teplota moře kolem Tenerife",
		"sea_temp_page_title_canary":   "Teplota moře okolo Kanárských ostrovů",
		"sea_temp_tenerife_h1":         "Teplota moře kolem Tenerife",
		"sea_temp_canary_h1":           "Teplota moře okolo Kanárských ostrovů",
		"sea_temp_tenerife_intro":      "Satelitní vizualizace vývoje povrchové teploty Atlantiku v okolí Tenerife podle dat Copernicus Marine.",
		"sea_temp_canary_intro":        "Satelitní vizualizace vývoje povrchové teploty Atlantiku v okolí Kanárských podle dat Copernicus Marine.",
		"sea_temp_period":              "Období",
		"sea_temp_frame_date":          "Datum snímku",
		"sea_temp_prev":                "Zpět",
		"sea_temp_next":                "Vpřed",
		"sea_temp_speed":               "Rychlost",
		"sea_temp_speed_slow":          "Pomalá",
		"sea_temp_speed_medium":        "Střední",
		"sea_temp_speed_fast":          "Rychlá",
		"sea_temp_play":                "Play",
		"sea_temp_pause":               "Pause",
		"sea_temp_img_alt":             "Snímek vizualizace teploty moře",
		"sea_temp_msg_invalid_period":  "Neplatné období.",
		"sea_temp_msg_no_data":         "Data pro tento měsíc zatím nejsou dostupná.",
		"sea_temp_msg_manifest_prefix": "Manifest nelze načíst",
		"sea_temp_msg_load_prefix":     "Nepodařilo se načíst Copernicus data",
		"sea_temp_msg_image_error":     "Chyba při načítání snímku.",
	},
	"en": {
		"sea_temp_page_title_tenerife": "Sea temperature around Tenerife",
		"sea_temp_page_title_canary":   "Sea temperature around the Canary Islands",
		"sea_temp_tenerife_h1":         "Sea temperature around Tenerife",
		"sea_temp_canary_h1":           "Sea temperature around the Canary Islands",
		"sea_temp_tenerife_intro":      "Satellite visualization of Atlantic sea surface temperature development around Tenerife based on Copernicus Marine data.",
		"sea_temp_canary_intro":        "Satellite visualization of Atlantic sea surface temperature development around the Canary Islands based on Copernicus Marine data.",
		"sea_temp_period":              "Period",
		"sea_temp_frame_date":          "Frame date",
		"sea_temp_prev":                "Back",
		"sea_temp_next":                "Next",
		"sea_temp_speed":               "Speed",
		"sea_temp_speed_slow":          "Slow",
		"sea_temp_speed_medium":        "Medium",
		"sea_temp_speed_fast":          "Fast",
		"sea_temp_play":                "Play",
		"sea_temp_pause":               "Pause",
		"sea_temp_img_alt":             "Sea temperature visualization frame",
		"sea_temp_msg_invalid_period":  "Invalid period.",
		"sea_temp_msg_no_data":         "Data for this month is not available yet.",
		"sea_temp_msg_manifest_prefix": "Unable to load manifest",
		"sea_temp_msg_load_prefix":     "Failed to load Copernicus data",
		"sea_temp_msg_image_error":     "Error loading frame image.",
	},
	"es": {
		"atlantic_viz":                 "Temperatura del Atlántico",
		"atlantic_tenerife":            "Tenerife",
		"atlantic_canary":              "Islas Canarias",
		"sea_temp_page_title_tenerife": "Temperatura del mar alrededor de Tenerife",
		"sea_temp_page_title_canary":   "Temperatura del mar alrededor de las Islas Canarias",
		"sea_temp_tenerife_h1":         "Temperatura del mar alrededor de Tenerife",
		"sea_temp_canary_h1":           "Temperatura del mar alrededor de las Islas Canarias",
		"sea_temp_tenerife_intro":      "Visualización satelital de la evolución de la temperatura superficial del Atlántico alrededor de Tenerife según datos de Copernicus Marine.",
		"sea_temp_canary_intro":        "Visualización satelital de la evolución de la temperatura superficial del Atlántico alrededor de las Islas Canarias según datos de Copernicus Marine.",
		"sea_temp_period":              "Período",
		"sea_temp_frame_date":          "Fecha de la imagen",
		"sea_temp_prev":                "Atrás",
		"sea_temp_next":                "Adelante",
		"sea_temp_speed":               "Velocidad",
		"sea_temp_speed_slow":          "Lenta",
		"sea_temp_speed_medium":        "Media",
		"sea_temp_speed_fast":          "Rápida",
		"sea_temp_play":                "Play",
		"sea_temp_pause":               "Pause",
		"sea_temp_img_alt":             "Imagen de visualización de temperatura del mar",
		"sea_temp_msg_invalid_period":  "Período no válido.",
		"sea_temp_msg_no_data":         "Los datos de este mes todavía no están disponibles.",
		"sea_temp_msg_manifest_prefix": "No se puede cargar el manifiesto",
		"sea_temp_msg_load_prefix":     "No se pudieron cargar los datos de Copernicus",
		"sea_temp_msg_image_error":     "Error al cargar la imagen.",
	},
	"pl": {
		"atlantic_viz":                 "Temperatura Atlantyku",
		"atlantic_tenerife":            "Teneryfa",
		"atlantic_canary":              "Wyspy Kanaryjskie",
		"sea_temp_page_title_tenerife": "Temperatura morza wokół Teneryfy",
		"sea_temp_page_title_canary":   "Temperatura morza wokół Wysp Kanaryjskich",
		"sea_temp_tenerife_h1":         "Temperatura morza wokół Teneryfy",
		"sea_temp_canary_h1":           "Temperatura morza wokół Wysp Kanaryjskich",
		"sea_temp_tenerife_intro":      "Satelitarna wizualizacja zmian temperatury powierzchni Atlantyku wokół Teneryfy na podstawie danych Copernicus Marine.",
		"sea_temp_canary_intro":        "Satelitarna wizualizacja zmian temperatury powierzchni Atlantyku wokół Wysp Kanaryjskich na podstawie danych Copernicus Marine.",
		"sea_temp_period":              "Okres",
		"sea_temp_frame_date":          "Data obrazu",
		"sea_temp_prev":                "Wstecz",
		"sea_temp_next":                "Dalej",
		"sea_temp_speed":               "Prędkość",
		"sea_temp_speed_slow":          "Wolna",
		"sea_temp_speed_medium":        "Średnia",
		"sea_temp_speed_fast":          "Szybka",
		"sea_temp_play":                "Play",
		"sea_temp_pause":               "Pause",
		"sea_temp_img_alt":             "Obraz wizualizacji temperatury morza",
		"sea_temp_msg_invalid_period":  "Nieprawidłowy okres.",
		"sea_temp_msg_no_data":         "Dane dla tego miesiąca nie są jeszcze dostępne.",
		"sea_temp_msg_manifest_prefix": "Nie można wczytać manifestu",
		"sea_temp_msg_load_prefix":     "Nie udało się wczytać danych Copernicus",
		"sea_temp_msg_image_error":     "Błąd ładowania obrazu.",
	},
	"de": {
		"atlantic_viz":                 "Atlantiktemperatur",
		"atlantic_tenerife":            "Teneriffa",
		"atlantic_canary":              "Kanarische Inseln",
		"sea_temp_page_title_tenerife": "Meerestemperatur rund um Teneriffa",
		"sea_temp_page_title_canary":   "Meerestemperatur rund um die Kanarischen Inseln",
		"sea_temp_tenerife_h1":         "Meerestemperatur rund um Teneriffa",
		"sea_temp_canary_h1":           "Meerestemperatur rund um die Kanarischen Inseln",
		"sea_temp_tenerife_intro":      "Satellitengestützte Visualisierung der Entwicklung der Atlantik-Oberflächentemperatur rund um Teneriffa anhand von Copernicus Marine Daten.",
		"sea_temp_canary_intro":        "Satellitengestützte Visualisierung der Entwicklung der Atlantik-Oberflächentemperatur rund um die Kanarischen Inseln anhand von Copernicus Marine Daten.",
		"sea_temp_period":              "Zeitraum",
		"sea_temp_frame_date":          "Bilddatum",
		"sea_temp_prev":                "Zurück",
		"sea_temp_next":                "Weiter",
		"sea_temp_speed":               "Geschwindigkeit",
		"sea_temp_speed_slow":          "Langsam",
		"sea_temp_speed_medium":        "Mittel",
		"sea_temp_speed_fast":          "Schnell",
		"sea_temp_play":                "Play",
		"sea_temp_pause":               "Pause",
		"sea_temp_img_alt":             "Bild der Meerestemperatur-Visualisierung",
		"sea_temp_msg_invalid_period":  "Ungültiger Zeitraum.",
		"sea_temp_msg_no_data":         "Für diesen Monat sind noch keine Daten verfügbar.",
		"sea_temp_msg_manifest_prefix": "Manifest kann nicht geladen werden",
		"sea_temp_msg_load_prefix":     "Copernicus-Daten konnten nicht geladen werden",
		"sea_temp_msg_image_error":     "Fehler beim Laden des Bildes.",
	},
	"fr": {
		"atlantic_viz":                 "Température de l'Atlantique",
		"atlantic_tenerife":            "Tenerife",
		"atlantic_canary":              "Îles Canaries",
		"sea_temp_page_title_tenerife": "Température de la mer autour de Tenerife",
		"sea_temp_page_title_canary":   "Température de la mer autour des îles Canaries",
		"sea_temp_tenerife_h1":         "Température de la mer autour de Tenerife",
		"sea_temp_canary_h1":           "Température de la mer autour des îles Canaries",
		"sea_temp_tenerife_intro":      "Visualisation satellite de l'évolution de la température de surface de l'Atlantique autour de Tenerife selon les données Copernicus Marine.",
		"sea_temp_canary_intro":        "Visualisation satellite de l'évolution de la température de surface de l'Atlantique autour des îles Canaries selon les données Copernicus Marine.",
		"sea_temp_period":              "Période",
		"sea_temp_frame_date":          "Date de l'image",
		"sea_temp_prev":                "Retour",
		"sea_temp_next":                "Suivant",
		"sea_temp_speed":               "Vitesse",
		"sea_temp_speed_slow":          "Lente",
		"sea_temp_speed_medium":        "Moyenne",
		"sea_temp_speed_fast":          "Rapide",
		"sea_temp_play":                "Play",
		"sea_temp_pause":               "Pause",
		"sea_temp_img_alt":             "Image de visualisation de la température de la mer",
		"sea_temp_msg_invalid_period":  "Période invalide.",
		"sea_temp_msg_no_data":         "Les données pour ce mois ne sont pas encore disponibles.",
		"sea_temp_msg_manifest_prefix": "Impossible de charger le manifeste",
		"sea_temp_msg_load_prefix":     "Impossible de charger les données Copernicus",
		"sea_temp_msg_image_error":     "Erreur lors du chargement de l'image.",
	},
	"it": {
		"atlantic_viz":                 "Temperatura dell'Atlantico",
		"atlantic_tenerife":            "Tenerife",
		"atlantic_canary":              "Isole Canarie",
		"sea_temp_page_title_tenerife": "Temperatura del mare intorno a Tenerife",
		"sea_temp_page_title_canary":   "Temperatura del mare intorno alle Isole Canarie",
		"sea_temp_tenerife_h1":         "Temperatura del mare intorno a Tenerife",
		"sea_temp_canary_h1":           "Temperatura del mare intorno alle Isole Canarie",
		"sea_temp_tenerife_intro":      "Visualizzazione satellitare dell'evoluzione della temperatura superficiale dell'Atlantico intorno a Tenerife secondo i dati Copernicus Marine.",
		"sea_temp_canary_intro":        "Visualizzazione satellitare dell'evoluzione della temperatura superficiale dell'Atlantico intorno alle Isole Canarie secondo i dati Copernicus Marine.",
		"sea_temp_period":              "Periodo",
		"sea_temp_frame_date":          "Data immagine",
		"sea_temp_prev":                "Indietro",
		"sea_temp_next":                "Avanti",
		"sea_temp_speed":               "Velocità",
		"sea_temp_speed_slow":          "Lenta",
		"sea_temp_speed_medium":        "Media",
		"sea_temp_speed_fast":          "Veloce",
		"sea_temp_play":                "Play",
		"sea_temp_pause":               "Pause",
		"sea_temp_img_alt":             "Immagine della visualizzazione della temperatura del mare",
		"sea_temp_msg_invalid_period":  "Periodo non valido.",
		"sea_temp_msg_no_data":         "I dati per questo mese non sono ancora disponibili.",
		"sea_temp_msg_manifest_prefix": "Impossibile caricare il manifest",
		"sea_temp_msg_load_prefix":     "Impossibile caricare i dati Copernicus",
		"sea_temp_msg_image_error":     "Errore durante il caricamento dell'immagine.",
	},
	"hu": {
		"atlantic_viz":                 "Atlanti hőmérséklet",
		"atlantic_tenerife":            "Tenerife",
		"atlantic_canary":              "Kanári-szigetek",
		"sea_temp_page_title_tenerife": "Tengerhőmérséklet Tenerife körül",
		"sea_temp_page_title_canary":   "Tengerhőmérséklet a Kanári-szigetek körül",
		"sea_temp_tenerife_h1":         "Tengerhőmérséklet Tenerife körül",
		"sea_temp_canary_h1":           "Tengerhőmérséklet a Kanári-szigetek körül",
		"sea_temp_tenerife_intro":      "Az Atlanti-óceán felszíni hőmérsékletének műholdas vizualizációja Tenerife környékén a Copernicus Marine adatai alapján.",
		"sea_temp_canary_intro":        "Az Atlanti-óceán felszíni hőmérsékletének műholdas vizualizációja a Kanári-szigetek környékén a Copernicus Marine adatai alapján.",
		"sea_temp_period":              "Időszak",
		"sea_temp_frame_date":          "Kép dátuma",
		"sea_temp_prev":                "Vissza",
		"sea_temp_next":                "Tovább",
		"sea_temp_speed":               "Sebesség",
		"sea_temp_speed_slow":          "Lassú",
		"sea_temp_speed_medium":        "Közepes",
		"sea_temp_speed_fast":          "Gyors",
		"sea_temp_play":                "Play",
		"sea_temp_pause":               "Pause",
		"sea_temp_img_alt":             "Tengerhőmérséklet-vizualizáció képe",
		"sea_temp_msg_invalid_period":  "Érvénytelen időszak.",
		"sea_temp_msg_no_data":         "Ehhez a hónaphoz még nem érhetők el adatok.",
		"sea_temp_msg_manifest_prefix": "A manifest nem tölthető be",
		"sea_temp_msg_load_prefix":     "A Copernicus adatok betöltése sikertelen",
		"sea_temp_msg_image_error":     "Hiba a kép betöltésekor.",
	},
}
...
var hourlyTableLocaleMessages = map[string]map[string]string{
	...
	"es": {
		...
		"hourly_values_for":  "Valores horarios para",
		"hour":               "Hora",
	},
	"pl": {
		"hourly_table_title": "Tabela godzinowa",
		"hourly_values_for":  "Wartości godzinowe dla",
		"hour":               "Godzina",
	},
	"de": {
		"hourly_table_title": "Stundentabelle",
		"hourly_values_for":  "Stundenwerte für",
		"hour":               "Stunde",
	},
	"fr": {
		"hourly_table_title": "Tableau horaire",
		"hourly_values_for":  "Valeurs horaires pour",
		"hour":               "Heure",
	},
	"it": {
		"hourly_table_title": "Tabella oraria",
		"hourly_values_for":  "Valori orari per",
		"hour":               "Ora",
	},
	"hu": {

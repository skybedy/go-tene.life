...
Použij tento prompt v novém AI coding chatu:

"Pracuj v aktuálním projektu a nejdřív si načti `AGENTS.md`, `PROJECT_CONTEXT.md`, `TODO.md` a `DECISIONS.md`.
Potom spusť `pwd`, `git branch --show-current` a `git status --short`.

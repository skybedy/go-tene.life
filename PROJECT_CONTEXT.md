...
- Dne 2026-05-04 byla na vetvi `experiment/wider-homepage-breakpoints` upravena responzivita weather stripu na uvodni strance a pozice odkazu na webkameru (presunut na horni hranu na vetsich displejich). Pozdeji byl tento odkaz predelan z plovouciho kolecka na sklenene tlacitko (glass-button) s textem "Zvětšit obrázek". Pro breakpoint `md` (768px-1023px) bylo písmo ve weather boxu zmenšeno o 20 % pro lepší čitelnost v užším prostoru.

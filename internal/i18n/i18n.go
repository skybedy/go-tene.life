...
var dictionary = map[string]map[string]string{
	"cs": {
		...
		"sounds_play":                 "Přehrát",
		"sounds_play_once":            "Přehrát jednou",
		"sounds_play_loop":            "Stále dokola",
		"sounds_download":             "Stáhnout",
		"sounds_play_all":             "Vše za sebou",
		"sounds_play_random":          "Náhodný výběr",
		"sounds_play_1_250":           "Část 1 (1–250)",
		"sounds_play_251_500":         "Část 2 (251–500)",
